...
export default function Hero() {
  return (
    <section className="bg-[linear-gradient(to_bottom,rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url(/TobamsheroImage.jpg)] bg-cover bg-center w-full flex flex-col items-center py-[112px] px-[64px]">
      <h1 className="bg-[#FFFFFF1A] uppercase py-2 px-10 rounded-full mb-3 text-white">
        What we do
      </h1>

...
export default function Footer() {
  return (
    <footer className="flex flex-col items-center justify-between px-10 py-5 w-full m-auto bg-[#11040E] ">
      <div className="bg-[#1D0617] w-full flex items-center justify-between px-10 py-5 text-white m-auto">
        <span>
      ...
      <div className="flex  justify-between gap-40 bg-[#11040E] p-10 w-full max-w-full m-auto">
        <div className="flex flex-col gap-6 w-[356px]">
          ...
          <span className="flex gap-4">
            <Image src="/linkedinlogo.png" alt="Logo" width={30} height={30} />
            <Image src="/instagramlogo.png" alt="Logo" width={30} height={30} />
      ...
      <div className="flex justify-between gap-50 mt-10 ">
        <div className="flex  ">
        ...
        <div className="flex flex-col text-left">
          ...
          <span className="flex gap-2 items-center">
            <Image src="/mailicon.png" alt="mail icon" width={30} height={30} />
      ...
      <hr className="my-5 border-[#DDD0DA] w-full" />
